...
<link rel="stylesheet" type="text/css" href="${rootPath}/static/css/member-write.css?ver=10-07-001" />
<script>
		...
		$.ajax({
			...
			success : function(result) {
				...
				if (result === "OK") {
					...
					$("div#msg_username span").text("사용이 불가능한 ID입니다")
					$("div#msg_username span").css("color", "red")
	...
	$(function() {
		...
		발생되는 event
		ID 중복 버튼을 클릭하지 않아도 ID 중복검사를 할수 있도록
