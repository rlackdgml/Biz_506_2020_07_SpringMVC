...
/*
 * MemberServiceImplV1 클래스의 필드변수가 있는 생성자를 자동으로 만들고 private final 로 선언된 객체에
 * Container로 부터 객체를 주입받아 사용할수 있도록 만들어주는 lombok의 Annotation
...
public class MemberServiceImplV1 implements MemberService {
	...
	/*
	 * 컨트롤러에서 회원정보를 전달받아서 비밀번호를 암호화 하고 userDao 보내서 저장하기
	 * 
	...
	public String userNameAndPassword(String username, String password) {
		...
		// 결과값에 따라 3항연산자를 사용하여 OK 도는 fail 문자열을 Controller 리턴함
